...
from ..entities.tarefa import Tarefa
...
def cadastrar_tarefa(request):
    ...
    return render(request, 'tasks/form_tarefa.html', {"form_tarefa": form_tarefa})
...
def remover_tarefa(request, id):
    ...
    if request.method == "POST":
        ...
        return redirect('listar_tarefas')
    return render(request, 'tasks/confirma_exclusao.html',  {"tarefa": tarefa_bd})
